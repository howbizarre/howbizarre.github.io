export default {
    ...
    template: `
        <div class="nav nav-tabs">
            ...
            <button class="nav-link active" data-bs-toggle="tab" :data-bs-target="'#lots-' + slug">
            ...
            <button class="nav-link" data-bs-toggle="tab" :data-bs-target="'#towns-' + slug">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
                    <path fill="none" d="M0 0h24v24H0z"/>
        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" :id="'lots-' + slug">
                <slot name="lots"></slot>
            </div>
            <div class="tab-pane fade" :id="'towns-' + slug">
